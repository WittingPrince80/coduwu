...
root=Tk()
root.title("Endless Pokimon game")
...
def player1():
    ...
    pokemon_list = ["pikachu.jpg","bulbasour.jpg","abra.jpg","charmander.jpg","lyvasour.jpg"]
    pokiHP = ["200","60","30","50","100"]
    random_no = random.randint(0,4)
    random_dice_label["text"] = "Player 1 Dice Random Number : " + str(random_no)
    player1_score = player1_score + pokiHP[random_no]
...
def player2():
    ...
    player2_score = player2_score + pokiHP[random_no2]
